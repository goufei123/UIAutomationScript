...
public class ProjectStepDef {
	...
	public void click_on_project_menu() throws Throwable {
		new WebDriverWait(driver, 6000).until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[@href='/u/pooja18lh/org/pooja18lh/projects'])[1]")));
		driver.findElement(By.xpath("(//a[@href='/u/pooja18lh/org/pooja18lh/projects'])[1]")).click();
	}
...
//			 } 
	...
	public void add_project() throws Throwable {
	    ...
	    Thread.sleep(5000);
	    driver.findElement(By.xpath("//button[@class='el-button el-tooltip setting-btn item el-button--success el-button--mini']")).click();
	...
	public void add_project(String arg1) throws Throwable {
		Thread.sleep(1000);
	    driver.findElement(By.xpath("//input[@type='search']")).clear();
	    driver.findElement(By.xpath("//input[@type='search']")).sendKeys("pooja18lh1/"+arg1+"");
		Thread.sleep(5000);
	    driver.findElement(By.xpath("(//button[text()='Search'])[1]")).click();
	    
	   // new WebDriverWait(driver, 2000).until(ExpectedConditions.elementToBeClickable(By.xpath("//div/span[text()='pooja18lh/'"+arg1+"")));
	    Thread.sleep(5000);
