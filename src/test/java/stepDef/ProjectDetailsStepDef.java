...
public class ProjectDetailsStepDef {
	...
	public void click_on_project_to_go_project_details_page() throws Throwable {
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("(//a/p[normalize-space()='example-rubygems-circle'])[2]")));
		try {
			if(Utility.isElementPresent(By.xpath("(//a/p[normalize-space()='example-rubygems-circle'])[2]"))) {
				driver.findElement(By.xpath("(//a/p[normalize-space()='example-rubygems-circle'])[2]")).click();
			}else {
			Thread.sleep(2000);
			  }
		}
...
//			    }
	...
	public void click_on_compare_button() throws Throwable {
		...
		driver.findElement(By.xpath("(//button/span[normalize-space()='Actions'])[3]")).click();
