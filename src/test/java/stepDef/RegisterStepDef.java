...
public class RegisterStepDef {
	...
	public void open_yopmail_in_new_tab_and_copy_mail_paste_in_email_field() throws Throwable {
		...
		WebElement email = driver.findElement(By.xpath("//span[text()='Copy to clipboard']"));
		email.click();
...
//		act.moveToElement(email).doubleClick().build().perform();
	...
	public void enter_the_username_and_email_and_password_and_confirm_password(String password1, String password2)throws Throwable {
	...
	public void enter_the_email_and_password(String arg1) throws Throwable {
		...
		driver.findElement(By.xpath("(//input[@name='password'])[2]")).clear();
		driver.findElement(By.xpath("(//input[@name='password'])[2]")).sendKeys(arg1);
		Thread.sleep(1000);
...
//	}
	...
	public void display_message_for_successfully_account_created() throws Throwable {
		new WebDriverWait(driver, 1000).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Please register using a permanent email address.']")));
	    String mailSent = driver.findElement(By.xpath("//p[text()='Please register using a permanent email address.']")).getText();
	    if (mailSent.contains("Please register using a permanent email address.")) {
	        System.out.println("\n"+mailSent);
	    }else {
