...
public class LoginStepDef {
	...
	public void enter_the_invalid_username_and_valid_password(String invalidUsername, String validPswd)
			throws Throwable {
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys(invalidUsername);
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys(validPswd);
	...
	public void logout_the_user_account() throws Throwable {
		Thread.sleep(1000);
		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/nav/div/div/ul[2]/li[4]/a/p")).click();
		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/nav/div/div/ul[2]/li[4]/ul/li[2]/a")).click();
	}
